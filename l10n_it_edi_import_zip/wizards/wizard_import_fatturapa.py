...
class WizardImportFatturapa(models.TransientModel):
    ...
    _description = "Import ZIP E-invoices"
    ...
    #     else:
    #         partner = fatturapa_attachment.xml_supplier_id
    #     return partner
    #
    # @api.model
    ...
    #     """
    #     if self._is_import_attachment_out():
    #         return self.get_debit_account(product=product)
    #     else:
            ...
            for filename in zip_ref.namelist():
                with zip_ref.open(filename) as file:
                    ...
                    if existing_attachment:
                        _logger.warning(f"E-invoice already exists: {filename}")
                        return False
