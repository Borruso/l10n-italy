...
7. Il campo "Termini e condizioni" viene scritto nel nodo "Causale" della fattura elettronica.
...
7. The field "Terms and Conditions" is written in the node "Causale" of the electronic invoice.
